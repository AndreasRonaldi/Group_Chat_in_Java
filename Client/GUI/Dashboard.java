...
public class Dashboard extends javax.swing.JFrame {
        ...
        public void handleRefresh(java.awt.event.ActionEvent evt) {
                ...
                ClientServer.handleGetGroupList();
        }

        public void handleChangeModelList(String groupStr) {
                @SuppressWarnings({ "unchecked", "rawtypes" })
                DefaultListModel<Group> res = (DefaultListModel) jList1.getModel();
                ...
                for (String group : groupArr) {
                        ...
                        res.addElement(new Group(tempGroup[1], tempGroup[2],
                                        Integer.parseInt(tempGroup[0])));
                }

                jList1.setModel(res);
        }

        public void handleCreateGroup(java.awt.event.ActionEvent evt) {
                String name = JOptionPane.showInputDialog("Enter Room Name");
                if (name == null)
                        return;
                System.out.println("> Creating Room " + name);
                ClientServer.handleCreateRoom(name);
        ...
        private void handleJoinGroup(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_handleJoinGroup
                ...
                if (group == null)
                        return;
                System.out.println("> Join id: " + group.id);
                ClientServer.handleJoinGroup(group);
        }
}